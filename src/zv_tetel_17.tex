...
\begin{center}
\input{src/tables/zv17_memoriakezeles_feladatok.tex}
\end{center}
...
A memória menedzselésének célja, hogy a rendelkezésre álló memóriát a lehető leghatékonyabban használjuk fel, miközben a folyamatok egymástól és az operációs rendszertől védetten működnek.
...
\input{src/figures/zv17_cimlekepzes_mmu.tex}
...
\begin{center}
\input{src/tables/zv17_cimlekepzes_es_cimkotes.tex}
\end{center}
...
\begin{center}
\input{src/tables/zv17_memoriakezelesi_modellek.tex}
\end{center}
...
\input{src/figures/zv17_fragmentacio.tex}
...
\begin{center}
\input{src/tables/zv17_folytonos_allokacios_algoritmusok.tex}
\end{center}
...
\input{src/figures/zv17_virtualis_memoria.tex}
...
\input{src/figures/zv17_lapozas_cimfelbontas.tex}
...
\begin{center}
\input{src/tables/zv17_lapozo_fogalmak.tex}
\end{center}
...
\input{src/figures/zv17_laphiba_kezelese.tex}
...
\begin{center}
\input{src/tables/zv17_lapcsere_algoritmusok.tex}
\end{center}
...
\begin{center}
\input{src/tables/zv17_lapozas_elonyok_hatranyok.tex}
\end{center}
