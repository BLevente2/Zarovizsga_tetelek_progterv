...
\begin{center}
\input{src/tables/zv06_grafalgoritmusok_osszefoglalo.tex}
\end{center}
...
\begin{center}
\input{src/tables/zv06_graf_reprezentaciok.tex}
\end{center}
...
\input{src/figures/zv06_bfs_dfs_bejaras.tex}
...
\input{src/figures/zv06_mst_vagas.tex}
...
\begin{center}
\input{src/tables/zv06_mst_osszehasonlitas.tex}
\end{center}
...
\input{src/figures/zv06_rovidut_kozelites.tex}
...
\input{src/figures/zv06_floyd_warshall_lepes.tex}
...
\begin{center}
\input{src/tables/zv06_rovidut_algoritmusok.tex}
\end{center}
