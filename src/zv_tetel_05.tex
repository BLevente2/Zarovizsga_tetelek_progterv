...
\begin{center}
\input{src/tables/zv05_rendezesek_osszefoglalo.tex}
\end{center}
...
\begin{center}
\input{src/tables/zv05_tulajdonsagok_osszefoglalo.tex}
\end{center}

\input{src/figures/rendezesek_csoportositasa.tex}
...
\input{src/figures/beszuro_rendezes_invarians.tex}
...
\input{src/figures/oszd_meg_uralkodj_rendezesek.tex}
...
\input{src/figures/gyorsrendezes_particionalas.tex}
...
\input{src/figures/leszamlalo_rendezes_folyamat.tex}
...
\begin{center}
\input{src/tables/zv05_linearis_rendezesek_feltetelei.tex}
\end{center}
...
\input{src/figures/osszehasonlito_rendezes_dontesi_fa.tex}
...
\begin{center}
\input{src/tables/zv05_idoigenyek_es_memoria.tex}
\end{center}
