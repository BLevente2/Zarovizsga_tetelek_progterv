...
\newcommand{\TETELNUMBER}{19}
\newcommand{\TETELTITLE}{Relációs adatmodell, ER modell és relációs algebra}
\newcommand{\TETELSHORTTITLE}{Relációs adatmodell}
...
\input{src/figures/zv19_adatbazis_tervezes_folyamat.tex}
...
\begin{center}
\input{src/tables/zv19_relacios_fogalmak.tex}
\end{center}
...
\begin{center}
\input{src/tables/zv19_integritasi_feltetelek.tex}
\end{center}
...
\begin{center}
\input{src/tables/zv19_er_elemek.tex}
\end{center}
...
\input{src/figures/zv19_er_jelolesek.tex}
...
\begin{center}
\input{src/tables/zv19_er_relacios_konverzio.tex}
\end{center}
...
\input{src/figures/zv19_er_konverzio_pelda.tex}
...
\input{src/figures/zv19_relacios_algebra_fa.tex}
...
\begin{center}
\input{src/tables/zv19_relacios_algebra_muveltek.tex}
\end{center}
